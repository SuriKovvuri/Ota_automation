...
describe(`Performance test for Parallel 2 adminlogin2`, () => {
    ...
    test('Login as admin land in dashboard and collect measures', async () => {
        ...
        lastMeasure = await reporter.getLastMeasures(`adminloginparallel2`);
        let action;
        ...
        currentMeasure = await measureAndReport(page, `adminloginparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Userlisting and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastUserMeasure = await reporter.getLastMeasures(`userlistingfirstparallel2`);
        ...
        currentUserMeasure = await measureAndReport(page, `userlistingfirstparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Userlisting and next page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastUserNextMeasure = await reporter.getLastMeasures(`userlistingnextparallel2`);
        ...
        currentUserNextMeasure = await measureAndReport(page, `userlistingnextparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Devicelisting and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastDeviceMeasure = await reporter.getLastMeasures(`devicelistingfirstparallel2`);
        ...
        currentDeviceMeasure = await measureAndReport(page, `devicelistingfirstparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Devicelisting and next page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastDeviceNextMeasure = await reporter.getLastMeasures(`devicelistingnextparallel2`);
        ...
        currentDeviceNextMeasure = await measureAndReport(page, `devicelistingnextparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Grouplisting and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastGroupMeasure = await reporter.getLastMeasures(`grouplistingfirstparallel2`);
        ...
        currentGroupMeasure = await measureAndReport(page, `grouplistingfirstparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Grouplisting and next page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastGroupNextMeasure = await reporter.getLastMeasures(`grouplistingnextparallel2`);
        ...
        currentGroupNextMeasure = await measureAndReport(page, `grouplistingnextparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Audit Page and collect measures', async () => {
        ...
        // get last adminlogin measures from the DB.
        lastAuditMeasure = await reporter.getLastMeasures(`auditlistingfirstparallel2`);
        ...
        currentAuditMeasure = await measureAndReport(page, `auditlistingfirstparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Auditlisting and next page and collect measures', async () => {
        let handle, action;
        // get last adminlogin measures from the DB.
        lastAuditNextMeasure = await reporter.getLastMeasures(`auditlistingnextparallel2`);
        ...
        // wrap the test and take measures.
        currentAuditNextMeasure = await measureAndReport(page, `auditlistingnextparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to AccessPage and collect measures', async () => {
        ...
        // get last adminlogin measures from the DB.
        lastAccessMeasure = await reporter.getLastMeasures(`accesslistingfirstparallel2`);
        //account book icon in left menu
        action = await performAction("click", leftpane.span.accountBook, page)
        expect(action).toBeTruthy()
        await delay(1000) //Not working without this delay
        ...
        currentAccessMeasure = await measureAndReport(page, `accesslistingfirstparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Accesslisting and next page and collect measures', async () => {
        let handle, action;
        // get last adminlogin measures from the DB.
        lastAccessNextMeasure = await reporter.getLastMeasures(`accesslistingnextparallel2`);
        ...
        // wrap the test and take measures.
        currentAccessNextMeasure = await measureAndReport(page, `accesslistingnextparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Org Page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastOrgMeasure = await reporter.getLastMeasures(`orglistingfirstparallel2`);
        ...
        currentOrgMeasure = await measureAndReport(page, `orglistingfirstparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Org and next page and collect measures', async () => {
        let handle;
        // get last adminlogin measures from the DB.
        lastOrgNextMeasure = await reporter.getLastMeasures(`orglistingnextparallel2`);
        ...
        // wrap the test and take measures.
        currentOrgNextMeasure = await measureAndReport(page, `orglistingnextparallel2`, async () => {
    ...
    test('Logged in as admin Navigate to Profile Page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastProfileMeasure = await reporter.getLastMeasures(`profilelistingfirstparallel2`);
        ...
        currentProfileMeasure = await measureAndReport(page, `profilelistingfirstparallel2`, async () => {
