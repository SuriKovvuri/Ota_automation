...
describe(`Performance test for Parallel 3 adminlogin3`, () => {
    ...
    test('Login as admin land in dashboard and collect measures', async () => {
        ...
        lastMeasure = await reporter.getLastMeasures(`adminloginparallel3`);
        let action;
        ...
        currentMeasure = await measureAndReport(page, `adminloginparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Userlisting and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastUserMeasure = await reporter.getLastMeasures(`userlistingfirstparallel3`);
        ...
        currentUserMeasure = await measureAndReport(page, `userlistingfirstparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Userlisting and next page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastUserNextMeasure = await reporter.getLastMeasures(`userlistingnextparallel3`);
        ...
        currentUserNextMeasure = await measureAndReport(page, `userlistingnextparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Devicelisting and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastDeviceMeasure = await reporter.getLastMeasures(`devicelistingfirstparallel3`);
        ...
        currentDeviceMeasure = await measureAndReport(page, `devicelistingfirstparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Devicelisting and next page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastDeviceNextMeasure = await reporter.getLastMeasures(`devicelistingnextparallel3`);
        ...
        currentDeviceNextMeasure = await measureAndReport(page, `devicelistingnextparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Grouplisting and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastGroupMeasure = await reporter.getLastMeasures(`grouplistingfirstparallel3`);
        ...
        currentGroupMeasure = await measureAndReport(page, `grouplistingfirstparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Grouplisting and next page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastGroupNextMeasure = await reporter.getLastMeasures(`grouplistingnextparallel3`);
        ...
        currentGroupNextMeasure = await measureAndReport(page, `grouplistingnextparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Audit Page and collect measures', async () => {
        ...
        // get last adminlogin measures from the DB.
        lastAuditMeasure = await reporter.getLastMeasures(`auditlistingfirstparallel3`);
        ...
        currentAuditMeasure = await measureAndReport(page, `auditlistingfirstparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Auditlisting and next page and collect measures', async () => {
        let handle, action;
        // get last adminlogin measures from the DB.
        lastAuditNextMeasure = await reporter.getLastMeasures(`auditlistingnextparallel3`);
        ...
        // wrap the test and take measures.
        currentAuditNextMeasure = await measureAndReport(page, `auditlistingnextparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to AccessPage and collect measures', async () => {
        ...
        // get last adminlogin measures from the DB.
        lastAccessMeasure = await reporter.getLastMeasures(`accesslistingfirstparallel3`);
        //account book icon in left menu
        action = await performAction("click", leftpane.span.accountBook, page)
        expect(action).toBeTruthy()
        await delay(1000) //Not working without this delay
        ...
        currentAccessMeasure = await measureAndReport(page, `accesslistingfirstparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Accesslisting and next page and collect measures', async () => {
        let handle, action;
        // get last adminlogin measures from the DB.
        lastAccessNextMeasure = await reporter.getLastMeasures(`accesslistingnextparallel3`);
        ...
        // wrap the test and take measures.
        currentAccessNextMeasure = await measureAndReport(page, `accesslistingnextparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Org Page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastOrgMeasure = await reporter.getLastMeasures(`orglistingfirstparallel3`);
        ...
        currentOrgMeasure = await measureAndReport(page, `orglistingfirstparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Org and next page and collect measures', async () => {
        let handle;
        // get last adminlogin measures from the DB.
        lastOrgNextMeasure = await reporter.getLastMeasures(`orglistingnextparallel3`);
        ...
        // wrap the test and take measures.
        currentOrgNextMeasure = await measureAndReport(page, `orglistingnextparallel3`, async () => {
    ...
    test('Logged in as admin Navigate to Profile Page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastProfileMeasure = await reporter.getLastMeasures(`profilelistingfirstparallel3`);
        ...
        currentProfileMeasure = await measureAndReport(page, `profilelistingfirstparallel3`, async () => {
