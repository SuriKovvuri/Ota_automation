...
describe(`Performance test for Parallel 1 adminlogin1`, () => {
    ...
    test('Login as admin land in dashboard and collect measures', async () => {
        ...
        lastMeasure = await reporter.getLastMeasures(`adminloginparallel1`);
        let action;
        ...
        currentMeasure = await measureAndReport(page, `adminloginparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to Userlisting and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastUserMeasure = await reporter.getLastMeasures(`userlistingfirstparallel1`);
        ...
        currentUserMeasure = await measureAndReport(page, `userlistingfirstparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to Userlisting and next page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastUserNextMeasure = await reporter.getLastMeasures(`userlistingnextparallel1`);
        ...
        currentUserNextMeasure = await measureAndReport(page, `userlistingnextparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to Devicelisting and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastDeviceMeasure = await reporter.getLastMeasures(`devicelistingfirstparallel1`);
        ...
        currentDeviceMeasure = await measureAndReport(page, `devicelistingfirstparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to Devicelisting and next page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastDeviceNextMeasure = await reporter.getLastMeasures(`devicelistingnextparallel1`);
        ...
        currentDeviceNextMeasure = await measureAndReport(page, `devicelistingnextparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to Grouplisting and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastGroupMeasure = await reporter.getLastMeasures(`grouplistingfirstparallel1`);
        ...
        currentGroupMeasure = await measureAndReport(page, `grouplistingfirstparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to Grouplisting and next page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastGroupNextMeasure = await reporter.getLastMeasures(`grouplistingnextparallel1`);
        ...
        currentGroupNextMeasure = await measureAndReport(page, `grouplistingnextparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to Audit Page and collect measures', async () => {
        ...
        // get last adminlogin measures from the DB.
        lastAuditMeasure = await reporter.getLastMeasures(`auditlistingfirstparallel1`);
        ...
        currentAuditMeasure = await measureAndReport(page, `auditlistingfirstparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to Auditlisting and next page and collect measures', async () => {
        let handle, action;
        // get last adminlogin measures from the DB.
        lastAuditNextMeasure = await reporter.getLastMeasures(`auditlistingnextparallel1`);
        ...
        // wrap the test and take measures.
        currentAuditNextMeasure = await measureAndReport(page, `auditlistingnextparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to AccessPage and collect measures', async () => {
        ...
        // get last adminlogin measures from the DB.
        lastAccessMeasure = await reporter.getLastMeasures(`accesslistingfirstparallel1`);
        //account book icon in left menu
        action = await performAction("click", leftpane.span.accountBook, page)
        expect(action).toBeTruthy()
        await delay(1000) //Not working without this delay
        ...
        currentAccessMeasure = await measureAndReport(page, `accesslistingfirstparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to Accesslisting and next page and collect measures', async () => {
        let handle, action;
        // get last adminlogin measures from the DB.
        lastAccessNextMeasure = await reporter.getLastMeasures(`accesslistingnextparallel1`);
        ...
        // wrap the test and take measures.
        currentAccessNextMeasure = await measureAndReport(page, `accesslistingnextparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to Org Page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastOrgMeasure = await reporter.getLastMeasures(`orglistingfirstparallel1`);
        ...
        currentOrgMeasure = await measureAndReport(page, `orglistingfirstparallel1`, async () => {
    ...
    test('Logged in as admin Navigate to Org and next page and collect measures', async () => {
        let handle;
        // get last adminlogin measures from the DB.
        lastOrgNextMeasure = await reporter.getLastMeasures(`orglistingnextparallel1`);
        ...
        // wrap the test and take measures.
        currentOrgNextMeasure = await measureAndReport(page, `orglistingnextparallel1`, async () => {
            //OTQA-1747 - Open issue
            /*
    ...
    test('Logged in as admin Navigate to Profile Page and collect measures', async () => {
        // get last adminlogin measures from the DB.
        lastProfileMeasure = await reporter.getLastMeasures(`profilelistingfirstparallel1`);
        ...
        currentProfileMeasure = await measureAndReport(page, `profilelistingfirstparallel1`, async () => {
