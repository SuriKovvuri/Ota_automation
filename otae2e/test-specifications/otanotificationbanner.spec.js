...
const feature = loadFeature('./otae2e/features/otanotificationbanner.feature',
    {
        errors: {
...
defineFeature(feature, test => {
    ...
    test('Create a notification banner',({
        given,
        when,
        and,
        then, 
      ...
      }) => 
      {
          ...
          whenICreateNotificationBanner(when)
        //   whenICreateNotificationBanner(when)
        //   andEnableNotificationBanner(and)
      })
})

//span[text()="Allow User to Dismiss"]//ancestor::label//input[@type="checkbox"]