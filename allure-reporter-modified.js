...
class AllureReporter {
    ...
    passTestCase() {
        ...
        console.log("in pass", this.steps.length)
        if (this.steps.length > 0) {
            for (const step of this.steps) {
                step.endStep();
                this.popStep();
    ...
    failTestCase(error) {
        ...
        console.log("in fail", this.steps.length)
        if (this.steps.length > 0) {
            for (const step of this.steps) {
                step.endStep();
                this.popStep();
    ...
    endTest() {
        ...
        console.log("in end", this.steps.length)
        if (this.steps.length > 0) {
            for (const step of this.steps) {
                step.endStep();
                this.popStep();
    ...
    handleError(error) {
        ...
        let trace = error.stack || error.message; //changes
